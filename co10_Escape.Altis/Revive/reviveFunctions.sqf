...
AT_FNC_Revive_Actions = {
	...
	{
		player addAction ["<t color=""#C90000"">" + "Revive" + "</t>", "Revive\reviveAction.sqf", ["revive"], 10, true, true, "", "call AT_FNC_Revive_Check_Revive"];
		player addAction ["<t color=""#C90000"">" + "Drag" + "</t>", "Revive\reviveAction.sqf", ["drag"], 9, false, true, "", "call AT_FNC_Revive_Check_Dragging"];
	};
...
//	};
	...
	else
	{
		...
		_unit setDamage 1;
		_unit setVariable ["AT_Revive_isUnconscious", 0, true];
