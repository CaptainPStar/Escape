...

{
    if (!isNil "_x") then {
        ...
        _x createDiaryRecord ["Diary", ["Intelligence Revealed", "CSAT and the AAF seem to know about the upcoming invasion, and are working hard on defensive preparations. They have stationed ammunition depots all over the area, as well as advanced communication centers guarded by heavy armor."]];
        _x createDiaryRecord ["Diary", ["Background", "Before the invasion of this region a group of highly skilled army specialists were sent into the heart of the enemy's territory. The goal of their mission was to gather intelligence, classified as top priority information, of CSAT's defensive structures. While the mission in itself was very successful and revealed even more useful information than hoped for, the withdrawal back across the border was not. On the small and snaky roads they made one single mistake and suddenly found themselves lost. If even just for a minute, it was enough to shortly thereafter run straight into a heavily guarded road block. Without a chance to fight they were caught and taken prisoners to a temporary outdoor prison already holding an engineer thought to be killed in a helicopter crash."]];
        _x createDiaryRecord ["Diary", ["Global Background", "NATO has secretly and for some time been planning the invasion of of the region beginning in a couple of weeks."]];
