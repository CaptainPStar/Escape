...
drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = ["CAF_AG_eeur_r_Offroad_armed_01", "CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_van_01", "O_Quadbike_01_F", "O_Truck_02_covered_F", "O_Truck_02_transport_F", "O_Truck_02_ammo_F", "O_Truck_02_box_F", "O_Truck_02_fuel_F", "O_Truck_02_medical_F", "O_MRAP_02_hmg_F"];
drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["CAF_AG_eeur_r_Offroad_armed_01", "CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_van_01", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_F"];
...
drn_arr_Escape_InfantryTypes =      ["CAF_AG_EEUR_R_AK47", "CAF_AG_EEUR_R_AK74", "CAF_AG_EEUR_R_GL", "CAF_AG_EEUR_R_RPG", "CAF_AG_EEUR_R_RPK74", "CAF_AG_EEUR_R_SVD"];
drn_arr_Escape_InfantryTypes_Ind =  ["CAF_AG_EEUR_R_AK47", "CAF_AG_EEUR_R_AK74", "CAF_AG_EEUR_R_GL", "CAF_AG_EEUR_R_RPG", "CAF_AG_EEUR_R_RPK74", "CAF_AG_EEUR_R_SVD"];
a3n_arr_recon_InfantryTypes = ["CAF_AG_EEUR_R_AK47", "CAF_AG_EEUR_R_AK74", "CAF_AG_EEUR_R_GL", "CAF_AG_EEUR_R_RPG", "CAF_AG_EEUR_R_RPK74", "CAF_AG_EEUR_R_SVD", "O_recon_exp_F", "O_recon_JTAC_F", "O_recon_M_F", "O_recon_medic_F", "O_recon_F", "O_recon_LAT_F", "O_recon_TL_F"];

// Random array. A roadblock has a manned vehicle. This array contains possible manned vehicles (can be of any kind, like cars, armored and statics).
drn_arr_Escape_RoadBlock_MannedVehicleTypes = ["CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_F", "O_HMG_01_high_F", "O_HMG_01_high_F", "O_static_AT_F", "O_static_AA_F"];
if (mechs_allowed) then {
...
drn_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "I_G_Offroad_01_armed_F", "I_static_AT_F"];
...
drn_arr_Escape_MotorizedSearchGroup_vehicleClasses = ["O_G_Offroad_01_armed_F", "CAF_AG_eeur_r_Offroad_armed_01"];
...
drn_arr_ComCenDefence_lightArmorClasses = ["CAF_AG_eeur_r_Offroad_armed_01", "O_MRAP_02_hmg_F"];
...
drn_arr_ComCenParkedVehicles = ["CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_van_01", "C_Offroad_01_F", "C_Van_01_transport_F", "O_MRAP_02_F", "I_G_Offroad_01_armed_F", "I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "I_G_Offroad_01_F"];
...
drn_arr_Escape_AmmoDepot_ParkedVehicleClasses = ["RDS_Ikarus_Civ_01", "RDS_Ikarus_Civ_02", "CAF_AG_eeur_r_Offroad_armed_01",  "CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_van_01", "O_Truck_02_covered_F", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_F"];
