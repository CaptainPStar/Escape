...
[_enemyMinSkill, _enemyMaxSkill, _enemyFrequency] spawn A3E_fnc_megaDrop;
sleep 0.3;
...
_chpTrg1 setTriggerStatements ["!(canMove chopper1)", "chopper1 setDamage 1; hint 'chopper 1 is dead'; chopper1Dead = 1", ""];
...
_chpTrg2 setTriggerStatements ["!(canMove chopper2)", "chopper2 setDamage 1; hint 'chopper 2 is dead'; chopper2Dead = 1", ""];
...
_chopper3 flyinheight A3E_FlyHeight;
